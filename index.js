...
const exitGame = () => {
    document.getElementById("rules").innerHTML = "Thanks for game"
    setTimeout(()=>{
        location.reload()
    },1500)
}
...
const getLetter = () => {
    ...
    if (userLetter.length > 1) {
        document.getElementById("rules").innerHTML = "Use single letter symbol"
        document.getElementById("answerInput").value = null
        setTimeout(()=>{
            document.getElementById("rules").innerHTML = "Write one letter in below"
        },1500)
    }else if (Number(userLetter)) {
        document.getElementById("rules").innerHTML = "Use only string"
        document.getElementById("answerInput").value = null
        setTimeout(()=>{
            document.getElementById("rules").innerHTML = "Write one letter in below"
        },1500)
    }else if (userLetter === "") {
        document.getElementById("rules").innerHTML = "You don't write letter"
        document.getElementById("answerInput").value = null
        setTimeout(()=>{
            document.getElementById("rules").innerHTML = "Write one letter in below"
        },1500)
